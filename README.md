...
Хороший пример Cucumber с ключевыми словами Given(условие - нахожусь на странице регистрации), When(действие - когда нажимаю "Отправить форму"), And(другое действие в рамках тестирования фичи),Then(результат - перенаправление на домашнюю страницу).
