...
Важно также знать о понятии *функциональная декомпозиция (functional decomposition) — процесс определенияфункции через её разделение на несколько низкоуровневых подфункций.* Это основополагающий подход суть которого состоит в упрощении решения поставленных задач и получения возможности повторного использования фрагментов кода для решения различных высокоуровневых задач. 
                                  
                                     Например для проверки процесса авторизации необходимо: 

1. Ввести имя пользователя:         2. Ввести пароль пользователя:   3. Отправить данные(форму):   4. Проверить результат:
 1.1. Найти поле.                   2.1. Найти поле.                   3.1. Найти кнопку             4.1. Найти надпись
 1.2. Заполнить поле.               2.2. Заполнить поле.               3.2. Нажать кнопку            4.2. Сравнить надпись
